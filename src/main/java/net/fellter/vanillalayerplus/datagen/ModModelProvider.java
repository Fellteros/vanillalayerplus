...
//        registerLayerBlock(ModBlocks.OAK_LOG_LAYER, Blocks.OAK_LOG, bsmg, blockAndTopForEnds(Blocks.OAK_LOG), blockAndTopForEnds(Blocks.OAK_LOG));
...
//        registerLayerBlock(ModBlocks.STR_OAK_LOG_LAYER, Blocks.STRIPPED_OAK_LOG, bsmg, blockAndTopForEnds(Blocks.STRIPPED_OAK_LOG), blockAndTopForEnds(Blocks.STRIPPED_OAK_LOG));
...
//        registerLayerBlock(ModBlocks.SPRUCE_LOG_LAYER, Blocks.SPRUCE_LOG, bsmg, blockAndTopForEnds(Blocks.SPRUCE_LOG), blockAndTopForEnds(Blocks.SPRUCE_LOG));
...
//        registerLayerBlock(ModBlocks.STR_SPRUCE_LOG_LAYER, Blocks.STRIPPED_SPRUCE_LOG, bsmg, blockAndTopForEnds(Blocks.STRIPPED_SPRUCE_LOG), blockAndTopForEnds(Blocks.STRIPPED_SPRUCE_LOG));
...
//        registerLayerBlock(ModBlocks.BIRCH_LOG_LAYER, Blocks.BIRCH_LOG, bsmg, blockAndTopForEnds(Blocks.BIRCH_LOG), blockAndTopForEnds(Blocks.BIRCH_LOG));
...
//        registerLayerBlock(ModBlocks.STR_BIRCH_LOG_LAYER, Blocks.STRIPPED_BIRCH_LOG, bsmg, blockAndTopForEnds(Blocks.STRIPPED_BIRCH_LOG), blockAndTopForEnds(Blocks.STRIPPED_BIRCH_LOG));
...
//        registerLayerBlock(ModBlocks.JUNGLE_LOG_LAYER, Blocks.JUNGLE_LOG, bsmg, blockAndTopForEnds(Blocks.JUNGLE_LOG), blockAndTopForEnds(Blocks.JUNGLE_LOG));
...
//        registerLayerBlock(ModBlocks.STR_JUNGLE_LOG_LAYER, Blocks.STRIPPED_JUNGLE_LOG, bsmg, blockAndTopForEnds(Blocks.STRIPPED_JUNGLE_LOG), blockAndTopForEnds(Blocks.STRIPPED_JUNGLE_LOG));
...
//        registerLayerBlock(ModBlocks.ACACIA_LOG_LAYER, Blocks.ACACIA_LOG, bsmg, blockAndTopForEnds(Blocks.ACACIA_LOG), blockAndTopForEnds(Blocks.ACACIA_LOG));
...
//        registerLayerBlock(ModBlocks.STR_ACACIA_LOG_LAYER, Blocks.STRIPPED_ACACIA_LOG, bsmg, blockAndTopForEnds(Blocks.STRIPPED_ACACIA_LOG), blockAndTopForEnds(Blocks.STRIPPED_ACACIA_LOG));
...
//        registerLayerBlock(ModBlocks.DARK_OAK_LOG_LAYER, Blocks.DARK_OAK_LOG, bsmg, blockAndTopForEnds(Blocks.DARK_OAK_LOG), blockAndTopForEnds(Blocks.DARK_OAK_LOG));
...
//        registerLayerBlock(ModBlocks.STR_DARK_OAK_LOG_LAYER, Blocks.STRIPPED_DARK_OAK_LOG, bsmg, blockAndTopForEnds(Blocks.STRIPPED_DARK_OAK_LOG), blockAndTopForEnds(Blocks.STRIPPED_DARK_OAK_LOG));
...
//        registerLayerBlock(ModBlocks.MANGROVE_LOG_LAYER, Blocks.MANGROVE_LOG, bsmg, blockAndTopForEnds(Blocks.MANGROVE_LOG), blockAndTopForEnds(Blocks.MANGROVE_LOG));
...
//        registerLayerBlock(ModBlocks.STR_MANGROVE_LOG_LAYER, Blocks.STRIPPED_MANGROVE_LOG, bsmg, blockAndTopForEnds(Blocks.STRIPPED_MANGROVE_LOG), blockAndTopForEnds(Blocks.STRIPPED_MANGROVE_LOG));
...
//        registerLayerBlock(ModBlocks.CHERRY_LOG_LAYER, Blocks.CHERRY_LOG, bsmg, blockAndTopForEnds(Blocks.CHERRY_LOG), blockAndTopForEnds(Blocks.CHERRY_LOG));
...
//        registerLayerBlock(ModBlocks.STR_CHERRY_LOG_LAYER, Blocks.STRIPPED_CHERRY_LOG, bsmg, blockAndTopForEnds(Blocks.STRIPPED_CHERRY_LOG), blockAndTopForEnds(Blocks.STRIPPED_CHERRY_LOG));
...
//        registerLayerBlock(ModBlocks.BAMBOO_BLOCK_LAYER, Blocks.BAMBOO_BLOCK, bsmg, blockAndTopForEnds(Blocks.BAMBOO_BLOCK), blockAndTopForEnds(Blocks.BAMBOO_BLOCK));
//        registerLayerBlock(ModBlocks.STR_BAMBOO_BLOCK_LAYER, Blocks.STRIPPED_BAMBOO_BLOCK, bsmg, blockAndTopForEnds(Blocks.STRIPPED_BAMBOO_BLOCK), blockAndTopForEnds(Blocks.STRIPPED_BAMBOO_BLOCK));
//
//        registerLayerBlock(ModBlocks.CRIMSON_LAYER, Blocks.CRIMSON_PLANKS, bsmg, TextureMap.all(Blocks.CRIMSON_PLANKS));
//        registerLayerBlock(ModBlocks.CRIMSON_STEM_LAYER, Blocks.CRIMSON_STEM, bsmg, blockAndTopForEnds(Blocks.CRIMSON_STEM), blockAndTopForEnds(Blocks.CRIMSON_STEM));
...
//        registerLayerBlock(ModBlocks.STR_CRIMSON_STEM_LAYER, Blocks.STRIPPED_CRIMSON_STEM, bsmg, blockAndTopForEnds(Blocks.STRIPPED_CRIMSON_STEM), blockAndTopForEnds(Blocks.STRIPPED_CRIMSON_STEM));
...
//        registerLayerBlock(ModBlocks.WARPED_STEM_LAYER, Blocks.WARPED_STEM, bsmg, blockAndTopForEnds(Blocks.WARPED_STEM), blockAndTopForEnds(Blocks.WARPED_STEM));
...
//        registerLayerBlock(ModBlocks.STR_WARPED_STEM_LAYER, Blocks.STRIPPED_WARPED_STEM, bsmg, blockAndTopForEnds(Blocks.STRIPPED_WARPED_STEM), blockAndTopForEnds(Blocks.STRIPPED_WARPED_STEM));
...
//
//        registerLayerBlock(ModBlocks.DEEPSLATE_LAYER, Blocks.DEEPSLATE, bsmg, blockAndTopForEnds(Blocks.DEEPSLATE), blockAndTopForEnds(Blocks.DEEPSLATE));
...
//        registerLayerBlock(ModBlocks.CHISELED_TUFF_LAYER, Blocks.CHISELED_TUFF, bsmg, blockAndTopForEnds(Blocks.CHISELED_TUFF), blockAndTopForEnds(Blocks.CHISELED_TUFF));
...
//        registerLayerBlock(ModBlocks.CHISELED_TUFF_BRICKS_LAYER, Blocks.CHISELED_TUFF_BRICKS, bsmg, blockAndTopForEnds(Blocks.CHISELED_TUFF_BRICKS), blockAndTopForEnds(Blocks.CHISELED_TUFF_BRICKS));
        ...
        Registries.BLOCK.forEach(block -> {
            if (Registries.BLOCK.getId(block).getNamespace().equals(VanillaLayerPlus.MOD_ID) && block instanceof LayerBlock) {
                ...
                Block fullBlock = ModBlocks.DATAGEN_ARGS.get(block).fullBlock;
